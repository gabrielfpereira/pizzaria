        ...
        <form action="{{ route('client.update', $client) }}" method="POST">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $client->name) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="João Santos...">
                    @if ($errors->has('name'))
                ...
                <div>
                    ...
                    <input type="tel" pattern="([0-9]{2})(\) ([0-9]{5})-([0-9]{4})" id="phone" name="phone" value="{{ old('phone', $client->phone) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="(00) 00000-000" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}">
                    @if ($errors->has('phone'))
            ...
            <div class="mb-6">
                ...
                <input type="address" id="address" name="address" value="{{ old('address', $client->address) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Rua 07 de Setembro, 100 ...">
